...
from group.models import Message, Comment, Reply
...
class GroupMessageNotification(models.Model):
    ...
    content = models.ForeignKey(Message, on_delete=models.CASCADE, null=True, blank=True)
...
class GroupCommentNotification(models.Model):
    ...
    content = models.ForeignKey(Comment, on_delete=models.CASCADE, null=True, blank=True)
...
class GroupReplyNotification(models.Model):
    ...
    content = models.ForeignKey(Reply, on_delete=models.CASCADE, null=True, blank=True)
